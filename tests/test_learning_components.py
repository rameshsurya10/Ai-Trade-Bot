...
def test_confidence_gate_basic():
    ...
    assert not can_trade, "Should not trade with 70% confidence"
    ...
    assert can_trade, "Should trade with 85% confidence"
    ...
    assert can_trade, "Should maintain TRADING at 77% (above 75% exit)"
